...
const AboutAngie = () => {
  ...
  return (
    <section className="py-20 lg:py-28 section-padding bg-card" id="about">
      <div className="container-wide">
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-3" {...r2} ref={r2.ref}>
            ...
            <blockquote className="mt-8 pl-6 border-l-4 border-accent italic font-body text-foreground text-lg">
