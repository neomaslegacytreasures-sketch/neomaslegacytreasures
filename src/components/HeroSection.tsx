    ...
    <section className="relative overflow-hidden bg-primary pt-28 pb-20 lg:pt-36 lg:pb-28 section-padding">
      <div className="container-wide">
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div {...r1} ref={r1.ref}>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-[1.25] text-primary-foreground mb-8">
            ...
            <div className="flex flex-wrap gap-4 mb-6">
              <a
                ...
                className="inline-flex items-center justify-center rounded-lg bg-accent px-7 py-3.5 font-label font-bold text-accent-foreground shadow-md hover:shadow-lg transition-shadow active:scale-[0.97] tracking-brand text-sm"
              >
                Shop the Binder on Etsy
              </a>
              <a
                href="#contact"
                className="inline-flex items-center justify-center rounded-lg border-2 border-primary-foreground/40 px-7 py-3.5 font-label font-bold text-primary-foreground transition-colors hover:bg-primary-foreground/10 active:scale-[0.97] tracking-brand text-sm"
              >
                Work With Angie
              </a>
              <a
                href="#checklist"
                className="inline-flex items-center justify-center rounded-lg bg-secondary px-7 py-3.5 font-label font-bold text-secondary-foreground shadow-sm hover:shadow-md transition-shadow active:scale-[0.97] tracking-brand text-sm"
              >
                Get Free Checklist
              </a>
            </div>
